    ...
    <div>
      ...
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
        ...
        <div className="absolute inset-0 w-full sm:my-20 sm:pt-1 pt-12 h-full ">
          <img className="w-96" src="https://i.ibb.co/5BCcDYB/Remote2.png" alt="Download Image" />
        </div>
      </aside>

      {/* Image Section */}
      <div className="grid  place-items-center sm:mt-20">
        <img className="sm:w-96 w-48" src="https://i.ibb.co/2M7rtLk/Remote1.png" alt="Image" />
      </div>
...
export default Landingpagerout;
